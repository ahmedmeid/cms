...
import se.alten.challenge.CmsApp;

import se.alten.challenge.domain.Vehicle;
import se.alten.challenge.domain.Customer;
...
public class VehicleResourceIntTest {
    ...
    public static Vehicle createEntity(EntityManager em) {
        Vehicle vehicle = new Vehicle()
            ...
            .vehicleRegNo(DEFAULT_VEHICLE_REG_NO);
        // Add required entity
    ...
    @Test
    @Transactional
    public void checkVehicleRegNoIsRequired() throws Exception {
        int databaseSizeBeforeTest = vehicleRepository.findAll().size();
        // set the field null
    ...
    public void getAllVehicles() throws Exception {
        ...
        restVehicleMockMvc.perform(get("/api/vehicles?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].vehicleRegNo").value(hasItem(DEFAULT_VEHICLE_REG_NO.toString())));
    }
    ...
    public void getVehicle() throws Exception {
        ...
        restVehicleMockMvc.perform(get("/api/vehicles/{id}", vehicle.getId()))
            ...
            .andExpect(jsonPath("$.vehicleRegNo").value(DEFAULT_VEHICLE_REG_NO.toString()));
    }
    ...
    public void updateVehicle() throws Exception {
        ...
        updatedVehicle
            ...
            .vehicleRegNo(UPDATED_VEHICLE_REG_NO);
